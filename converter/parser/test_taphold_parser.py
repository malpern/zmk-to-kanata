...
"""Unit tests for the tap-hold parser."""
import pytest
...
# Fixture needed: taphold_parser
@pytest.fixture
def taphold_parser():
    return TapHoldParser()

@pytest.mark.skip(reason="TapHoldParser likely needs refactoring")
def test_basic_holdtap_properties(taphold_parser: TapHoldParser):
...
@pytest.mark.skip(reason="TapHoldParser likely needs refactoring")
def test_full_configuration(taphold_parser: TapHoldParser):
...
@pytest.mark.skip(reason="TapHoldParser likely needs refactoring")
def test_advanced_features(taphold_parser: TapHoldParser):
...
@pytest.mark.skip(reason="TapHoldParser likely needs refactoring")
def test_partial_configuration(taphold_parser: TapHoldParser):
...
@pytest.mark.skip(reason="TapHoldParser likely needs refactoring")
def test_real_world_example(taphold_parser: TapHoldParser):
