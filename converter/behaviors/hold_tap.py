...
class HoldTapBinding:
    ...
    def __post_init__(self):
        ...
        if not isinstance(self.tap_key, str):
            # TODO: Log error via error manager
            raise TypeError("tap_key must be a string")
        if self.hold_trigger_key_positions is not None and not isinstance(self.hold_trigger_key_positions, tuple):
            # TODO: Log error via error manager
            raise TypeError("hold_trigger_key_positions must be a tuple of ints or None")
...
class HoldTapBehavior:
    ...
    def __post_init__(self):
        ...
        if self.tapping_term_ms is not None and not isinstance(self.tapping_term_ms, int):
            # TODO: Log error via error manager
        ...
        if self.require_prior_idle_ms is not None and not isinstance(self.require_prior_idle_ms, int):
            # TODO: Log error via error manager
        ...
        if self.hold_trigger_key_positions is not None and not isinstance(self.hold_trigger_key_positions, list):
            # TODO: Log error via error manager
